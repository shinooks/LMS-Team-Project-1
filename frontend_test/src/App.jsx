                ...
                <tr key={row}>
                  ...
                  {Array.from({ length: 5 }).map((_, col) => (
                      <td key={col} style={{
                        ...
                        {myTimeTable[row][col] && (
                            <>
                              <div>강의번호: {myTimeTable[row][col].courseCode}</div>
                              <div>{myTimeTable[row][col].courseName}</div>
                            </>
                        )}
                      </td>
                  ))}
          ...
          {enrolledClasses.length === 0 ? (
              ...
              enrolledClasses.map((enrolledClass, index) => (
                  <div key={index} style={{ margin: '10px 0' }}>
                    ...
                    현재인원: {enrolledClass.currentStudents}&nbsp;&nbsp;&nbsp;
                    최대인원: {enrolledClass.maxStudents}&nbsp;&nbsp;&nbsp;
                    학점: {enrolledClass.credits}&nbsp;&nbsp;&nbsp;
                    요일: {enrolledClass.dayOfWeek}&nbsp;&nbsp;&nbsp;
